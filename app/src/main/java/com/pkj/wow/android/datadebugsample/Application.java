...
import com.pkj.wow.android.datadebugsample.data.ClipTextDbHelper;
import com.pkj.wow.android.datadebugsample.util.PreferenceManager;
...
public class Application extends android.app.Application {
    ...
    private ClipTextDbHelper mDbHelper;
    ...
    public void onCreate() {
        ...
        PreferenceManager.initPref(this);
    }

    public SQLiteDatabase getWritableClipDatabase(){
        if(mDbHelper == null) mDbHelper  = new ClipTextDbHelper(this);
